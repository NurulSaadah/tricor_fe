<template>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="content-subtab">
                                <!--<form class="g-3 mt-1" method="post" @submit.prevent="addSales()">-->
                                    <div class="row">
                                        <div class="col-md-7 mb-2">
                                            
                                            <label for="" class="form-label">Sales Agent : {{this.staff}}</label><br>
                                            <label for="" class="form-label">Date : {{ this.currentdate }}</label>
                                       </div>
                                    </div>
                                    <!--<div class="row">
                                        <div class="col-md-6 mb-1">
                                            <label for="" class="form-label">Reference Number</label>
                                            <input type="text" class="form-control" placeholder="Enter Reference Number" v-model="reference_no" />
                                        </div>
                                    </div>-->
                                    <div class="row">
                                        <div class="col-md-6 mb-1">
    ...
    export default {
        ...
        computed: {
            ...
            // Use reduce to sum up the total amounts of all items in newList.items
        ...
        methods: {
           ...
           NumbersOnly(evt) {
            ...
            addItem() {
                ...
                // Use plain JavaScript to add the item to newList.items
            ...
            addSales() {
                ...
                this.$swal.fire({title: 'Update this transaction?',showCancelButton: true,confirmButtonText: 'Yes',cancelButtonText: 'Cancel',reverseButtons: true}
                ).then(async (result) =>{
