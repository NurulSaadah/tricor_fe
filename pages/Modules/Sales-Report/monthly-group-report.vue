          ...
          <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="card-header icon-title">
                            ...
                            <h4>Monthly Group Sales Report</h4>
                        </div>
              <div class="card-body">
                ...
                <div style="overflow-x:auto;">
                  ...
                  <tbody>
                    ...
                    <tr v-if="!monthlylist.length">
                    <td colspan="5"><p style=" padding: 0px;
                      margin: 10px;
                      color: red;
                      display: flex;
     ...
     async GetList() {
      //alert(this.selectedYear + "|" + this.selectedMonth)
        ...
        const response = await this.$axios.post(
          "sales/getMonthlySalesManager",{staff_id:this.userdetails.user.staff_id, year:this.selectedYear, month:this.selectedMonth},
          {headers,}
        );
