                ...
                <div
                  ...
                  <form class="g-3 mt-3" method="post" @submit.prevent="onAddparameter()">
                    ...
                    <div class="d-flex justify-content-center" id="hidebutton1" ref="hidebutton1">
                      <button type="submit" class="btn btn-success btn-text" v-if="Id"><i class="fa fa-save"></i>Update</button>
                      <button type="submit" class="btn btn-success btn-text" v-if="!Id"><i class="fa fa-plus"></i> Add New</button>
                    </div>
                  </form>
                  ...
                  <table class="table table-striped data-table1 display nowrap" style="width: 100%">
                    ...
                    <tbody>
                      <tr v-for="(rg, index) in list" :key="index">
                        ...
                        <td>
                          <a class="view" @click="editreg(rg)"><i class="fa fa-edit"></i></a>
